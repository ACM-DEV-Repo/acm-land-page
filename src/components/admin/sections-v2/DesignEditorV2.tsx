...
const DESIGN_PRESETS: DesignPreset[] = [
  ...
  {
    id: 'acm',
    name: 'ACM Institucional',
    description: 'Verde médico ACM + Glass Apple Premium',
    preview: 'bg-gradient-to-br from-[#0A1A12] to-[#0F2A1C]',
    values: {
      preset: 'acm',
      primaryColor: '#009023',
      secondaryColor: '#0693E3',
      ...
      iconColor: '#00B82E',
      starColor: '#FFD700',
      textPrimaryColor: '#F0FFF6',
      textSecondaryColor: '#7DD3A1',
      gradient: { from: '#0A1A12', to: '#0F2A1C' },
      glassIntensity: 0.12,
      cardRoundness: 'medio' as const,
      verticalSpacing: 'medium' as const,
      fontFamily: 'Inter, sans-serif',
  ...
  },
  {
    id: 'saude-rosa',
    name: 'Saúde Feminina',
    description: 'Rosa sofisticado + Terracotta — Wellness Premium',
    preview: 'bg-gradient-to-br from-[#1C0F14] to-[#2A1520]',
    values: {
      preset: 'saude-rosa',
      primaryColor: '#D4608A',
      secondaryColor: '#C4856C',
      ...
      iconColor: '#E88FAA',
      starColor: '#F5C77E',
      textPrimaryColor: '#FFF0F5',
      textSecondaryColor: '#D4A0B0',
      gradient: { from: '#1C0F14', to: '#2A1520' },
      glassIntensity: 0.11,
      cardRoundness: 'medio' as const,
      verticalSpacing: 'medium' as const,
      fontFamily: 'Inter, sans-serif',
