  ...
  return (
    <section className="w-full py-16 md:py-24 px-4 md:px-6">
      <div className="max-w-6xl mx-auto text-center">
        ...
        <p className="mb-12 md:mb-16 text-base md:text-lg lg:text-xl text-muted-foreground max-w-3xl mx-auto leading-relaxed">{data.text}</p>
        {(data.imageDesktop || data.imageMobile) && (
          <div className="w-full max-w-4xl mx-auto rounded-[var(--ds-radius)] aspect-video overflow-hidden glass-card flex items-center justify-center">
            <picture>
              ...
              <img loading="lazy" src={data.imageDesktop || data.imageMobile} className="w-full h-full object-cover" alt="Sobre" />
            </picture>
          </div>
        )}
