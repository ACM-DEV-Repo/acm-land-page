...
type WhyChooseV2Props = { data: LPContent["whyChoose"]; lpKey: string; couponCode?: string };
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
          {data.items?.map((item, index) => {
            ...
            <div key={index} className="glass-card p-8 md:p-10 hover:scale-[1.02] transition-all duration-300">
              <div className="flex justify-center mb-5"><IconBadgeV2 icon={IconComp} /></div>
        ...
        {(data.imageDesktop || data.imageMobile) && (
          <div className="w-full max-w-5xl mx-auto mt-12 md:mt-20 rounded-[var(--ds-radius)] aspect-video overflow-hidden glass-card">
            <picture>
              ...
              <img loading="lazy" src={data.imageDesktop || data.imageMobile} className="w-full h-full object-cover" alt="Por que escolher" />
            </picture>
          </div>
        )}
